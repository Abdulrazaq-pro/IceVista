...
const Header = () => {
  ...
  return (
    <div className="px-6 py-2 flex justify-between  items-center sticky top-0 left-0 bg-blue_3 z-[999]" >
      ...
      <div className="menu md:hidden" onClick={()=>{
        setNav(!nav)
      }}>
        <p className="">menu</p>
      </div>

      {nav?<div className="fixed bg-white text-black w-[90%] left-[50%] top-14 translate-x-[-50%] py-7 px-5 text-2xl rounded-3xl z-[999]">
